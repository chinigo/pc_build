...
| Motherboard     | *TBD*     |           | Verify compatibility w/CPU socket and RAM spec. Make sure fan headers support PCM (many have a dual PCM/DC mode you can toggle from BIOS).                                                                                                                 |
| CPU             | *TBD*     |           |                                                                                                                                                                                                                                                            |
| GPU             | *TBD*     |           |                                                                                                                                                                                                                                                            |
...
| Case fans       | *TBD*     |           | Bigger radius = more airflow at given RPM (and thus sound level). You want a buncha big, slow fans. Get PCM-controlled instead of DC-controlled.                                                                                                           |
...
| Fan controller  | *TBD*     |           | You'll probably end up having more fans than motherboard fan headers. A controller lets you signal multiple fans from same header. Gotta be PCM instead of DC as well.                                                                                     |
